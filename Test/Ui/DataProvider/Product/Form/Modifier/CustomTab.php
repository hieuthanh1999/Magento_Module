<?php 
namespace AHT\Test\Ui\DataProvider\Product\Form\Modifier; 
...
class CustomTab extends AbstractModifier { 
    const SAMPLE_FIELDSET_NAME = 'custom_grid_fieldset';
     ...
     /** * @var array */ protected $meta = [];
     /** * @param LocatorInterface $locator 
      * * @param ArrayManager $arrayManager 
      * @param UrlInterface $urlBuilder 
      */ 
      public function __construct( LocatorInterface $locator, ArrayManager $arrayManager, 
      UrlInterface $urlBuilder, \Magento\Catalog\Model\ProductFactory $_productloader, 
